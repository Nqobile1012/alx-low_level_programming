 ...
 * Description: if file is no an ELF, exit code 98
 */
...
/**
 * print_class - prints class of an elf hedaer
 ...
 * Descriptiion: if file can't be closed exit code 98
 */
...
/**
 * main - displays info in elf header
 * @argc: number of args
